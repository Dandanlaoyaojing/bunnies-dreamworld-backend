...
async function createGroupsTables() {
  ...
  try {
    ...
    `);
    console.log('✅ 组群成员表创建成功');
    
    // 创建组群融合记录表
    console.log('🔄 创建组群融合记录表...');
    await connection.execute(`
    ...
    `);
    console.log('✅ 共享节点表创建成功');
    
    // 创建共享节点关联表
    console.log('🔄 创建共享节点关联表...');
    await connection.execute(`
    ...
    `);
    console.log('✅ 共享节点关联表创建成功');
    
    // 创建节点贡献记录表
    console.log('🔄 创建节点贡献记录表...');
    await connection.execute(`
